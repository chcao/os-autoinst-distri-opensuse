...
sub run {
    ...
    install_package('command-not-found', trup_continue => 1, trup_reboot => 1) if (check_var('DESKTOP', 'textmode'));    # command-not-found is part of the enhanced_base pattern, missing in textmode
